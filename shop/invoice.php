...
function addClientAdresse( $addresse )
{
	...
	$this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "Delivery Adddress", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,5,$addresse, 0,0, "C");
}

function addRemarque($remarque)
{
	$this->SetFont( "Arial", "", 10);
	$length = $this->GetStringWidth( "Color/Size Info : " . $remarque );
	$r1  = 146;
	$r2  = $r1 + $length;
	$y1  = 93;
	$y2  = $y1+5;
	$this->SetXY( $r1 , $y1 );
	$this->Cell($length,4, "Color/Size Info : " . $remarque);
}
function addTotalCost($tc)
{   
	$this->SetFont( "Arial", "B", 10);
	$r1  = 160;
	$r2  = $r1 + 40;
	...
	$this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "TOTAL COST", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,5,$tc ." Ks", 0,0, "C");
...
function addReglement( $mode )
{
	...
	$this->SetXY( $r1 + ($r2-$r1)/2 -5 , $y1+1 );
	$this->SetFont( "Arial", "B", 10);	
	$this->Cell(10,4, "Cash On Delivery", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 -5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
...
function addEcheance( $date )
{
	...
	$this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "Order Due Date", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
...
{
	$this->SetFont( "Arial", "", 10);
	$length = $this->GetStringWidth( "Total Cost : " . $tc );
	$r1  = 10;
	$r2  = $r1 + $length;
	$y1  = $this->h - 45.5;
	$y2  = $y1+5;
	$this->SetXY( $r1 , $y1 );
	$this->Cell($length,4, "Total Cost : " . $tc . " Ks");
}*/
...
// Entre Euros & Francs;
	...
	$this->SetFont( "Arial", "B", 6);
	$this->SetXY( $r1+10, $y1 );
	$this->Cell(4,4, "TOTAL COST :", 0, 0, "C");
}
