		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class="">&nbsp;&nbsp;&nbsp;</li>
			  <li class="">&nbsp;&nbsp;&nbsp;</li>
			  <li class="active"><a href="new-products.php">What's New</a></li>
			  <li class="">&nbsp;&nbsp;&nbsp;</li>
...
<div class="well well-small" style="font-family: calibri;font-size: 19px;color:darkcyan;">
	<p>Items shown below are recently added items and updated design and icons.</p>
</div>
<hr class="soften"/>		
		  <ul class="thumbnails">
			<?php
          $sql = $mysqli->query("SELECT * FROM product WHERE Status='InStock' GROUP BY productid DESC LIMIT 6");
          if($sql){
